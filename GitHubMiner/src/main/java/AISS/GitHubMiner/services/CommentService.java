...
public class CommentService {
    ...
    public List<Comment> getAllCommentsOfAnIssue(String owner, String repo, String Inumber) {
    ...
    public Comment getOneCommentById(String owner, String repo, String commentId) {
        Comment c = null;
